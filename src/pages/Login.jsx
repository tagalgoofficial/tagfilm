        ...
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#050514]">
            ...
            <div className="z-10 w-full max-w-md p-8 sm:p-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl mx-4">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2 font-arabic">تسجيل الدخول</h1>
                    <p className="text-gray-400 text-sm font-arabic">مرحباً بك مجدداً في تاج فيلم</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2 mr-1">
                            <label className="block text-gray-400 text-sm font-arabic">كلمة المرور</label>
                            <Link to="/forgot-password" size="sm" className="text-blue-400 text-xs hover:text-blue-300 font-arabic">نسيت كلمة المرور؟</Link>
                        </div>
                        <input
                            type="password"
                            required
