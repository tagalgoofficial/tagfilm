    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#050514]">
            ...
            <motion.div
                ...
                className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-yellow-500/10 blur-[120px] rounded-full"
            ></motion.div>
            <motion.div
                animate={{
                    scale: [1, 1.3, 1],
                ...
                className="absolute bottom-[-20%] left-[-10%] w-[60%] h-[60%] bg-orange-600/10 blur-[150px] rounded-full"
            ></motion.div>
            ...
            >
                ...
                <div className="absolute inset-0 rounded-[2.5rem] border border-yellow-400/0 group-hover:border-yellow-400/20 transition-all duration-700 pointer-events-none"></div>
                ...
                <div className="flex flex-col items-center mb-10">
                    <motion.div
                        ...
                        className="relative"
                    >
                        <img src={logo} alt="TagFilm Logo" className="h-24 mb-8 drop-shadow-[0_0_20px_rgba(255,215,0,0.3)]" />
                    </motion.div>
                    <h1 className="text-4xl font-black text-white mb-3 font-arabic text-center tracking-tight">تسجيل الدخول</h1>
                    <p className="text-gray-400 text-sm font-arabic font-medium opacity-80">استمتع بتجربة سينمائية فريدة</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center mb-1 mr-1">
                            <label className="block text-gray-300 text-xs font-bold uppercase tracking-widest font-arabic opacity-60">كلمة المرور</label>
                            <Link to="/forgot-password" size="sm" className="text-yellow-500/70 text-[10px] uppercase font-bold hover:text-yellow-400 font-arabic transition-colors">نسيت كلمة المرور؟</Link>
                        </div>
                        <div className="relative group/field">
                    ...
                    >
                        ...
                        <span className="relative z-10">{loading ? 'جاري التحقق...' : 'دخول'}</span>
                        {!loading && <FiArrowRight className="relative z-10 text-xl" />}
                    </motion.button>
                </form>
                ...
                <div className="mt-10 pt-8 border-t border-white/5 text-center">
                    <p className="text-gray-400 font-arabic text-sm">
                        مستخدم جديد؟{' '}
                        <Link to="/signup" className="text-yellow-400 hover:text-yellow-300 font-black transition-colors ml-1 border-b border-yellow-400/30">
                            أنشئ حساباً الآن
                        </Link>
                    </p>
                </div>
